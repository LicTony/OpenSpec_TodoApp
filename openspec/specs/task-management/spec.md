...
Provides interactive console-based task management capabilities including adding, viewing, and deleting tasks.
...
- **AND** when the user confirms with 's' or 'S'
...
- **AND** the user responds with 'n' or 'N'
- **THEN** the system displays "Eliminación cancelada"
- **AND** the menu is displayed again
